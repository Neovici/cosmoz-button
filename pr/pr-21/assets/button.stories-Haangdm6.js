import{D as K,A as b,b as a}from"./iframe-SKMTbDqX.js";import"./preload-helper-PPVm8Dsz.js";let E,j=0;function $(t){E=t}function I(){E=null,j=0}function tt(){return j++}const L=Symbol("haunted.phase"),A=Symbol("haunted.hook"),O=Symbol("haunted.update"),W=Symbol("haunted.commit"),v=Symbol("haunted.effects"),z=Symbol("haunted.layoutEffects"),P="haunted.context";class ot{update;host;virtual;[A];[v];[z];constructor(o,e){this.update=o,this.host=e,this[A]=new Map,this[v]=[],this[z]=[]}run(o){$(this);let e=o();return I(),e}_runEffects(o){let e=this[o];$(this);for(let n of e)n.call(this);I()}runEffects(){this._runEffects(v)}runLayoutEffects(){this._runEffects(z)}teardown(){this[A].forEach(e=>{typeof e.teardown=="function"&&e.teardown(!0)})}}const et=Promise.resolve().then.bind(Promise.resolve());function N(){let t=[],o;function e(){o=null;let n=t;t=[];for(var s=0,i=n.length;s<i;s++)n[s]()}return function(n){t.push(n),o==null&&(o=et(e))}}const nt=N(),F=N();class st{renderer;host;state;[L];_updateQueued;_active;constructor(o,e){this.renderer=o,this.host=e,this.state=new ot(this.update.bind(this),e),this[L]=null,this._updateQueued=!1,this._active=!0}update(){this._active&&(this._updateQueued||(nt(()=>{let o=this.handlePhase(O);F(()=>{this.handlePhase(W,o),F(()=>{this.handlePhase(v)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(o,e){switch(this[L]=o,o){case W:this.commit(e),this.runEffects(z);return;case O:return this.render();case v:return this.runEffects(v)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(o){this.state._runEffects(o)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const U=(...t)=>{const o=new CSSStyleSheet;return o.replaceSync(t.join("")),o},rt=t=>t?.map(o=>typeof o=="string"?U(o):o),at=(t,...o)=>t.flatMap((e,n)=>[e,o[n]||""]).join(""),T=at,it=(t="")=>t.replace(/-+([a-z])?/g,(o,e)=>e?e.toUpperCase():"");function ct(t){class o extends st{frag;renderResult;constructor(s,i,u){super(s,u||i),this.frag=i}commit(s){this.renderResult=t(s,this.frag)}}function e(n,s,i){const u=(i||s||{}).baseElement||HTMLElement,{observedAttributes:D=[],useShadowDOM:Y=!0,shadowRootInit:X={},styleSheets:Z}=i||s||{},V=rt(n.styleSheets||Z);class R extends u{_scheduler;static get observedAttributes(){return n.observedAttributes||D||[]}constructor(){if(super(),Y===!1)this._scheduler=new o(n,this);else{const r=this.attachShadow({mode:"open",...X});V&&(r.adoptedStyleSheets=V),this._scheduler=new o(n,r,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(r,d,c){if(d===c)return;let l=c===""?!0:c;Reflect.set(this,it(r),l)}}function q(h){let r=h,d=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return r},set(c){d&&r===c||(d=!0,r=c,this._scheduler&&this._scheduler.update())}})}const J=new Proxy(u.prototype,{getPrototypeOf(h){return h},set(h,r,d,c){let l;return r in h?(l=Object.getOwnPropertyDescriptor(h,r),l&&l.set?(l.set.call(c,d),!0):(Reflect.set(h,r,d,c),!0)):(typeof r=="symbol"||r[0]==="_"?l={enumerable:!0,configurable:!0,writable:!0,value:d}:l=q(d),Object.defineProperty(c,r,l),l.set&&l.set.call(c,d),!0)}});return Object.setPrototypeOf(R.prototype,J),R}return e}class m{id;state;constructor(o,e){this.id=o,this.state=e}}function lt(t,...o){let e=tt(),n=E[A],s=n.get(e);return s||(s=new t(e,E,...o),n.set(e,s)),s.update(...o)}function p(t){return lt.bind(null,t)}function Q(t){return p(class extends m{callback;lastValues;values;_teardown;constructor(o,e,n,s){super(o,e),t(e,this)}update(o,e){this.callback=o,this.values=e}call(){const o=!this.values||this.hasChanged();this.lastValues=this.values,o&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(o){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),o&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((o,e)=>this.lastValues[e]!==o)}})}function G(t,o){t[v].push(o)}const dt=Q(G),ut=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,ht=p(class extends m{Context;value;_ranEffect;_unsubscribe;constructor(t,o,e){super(t,o),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,G(o,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const o={Context:t,callback:this._updater};ut(this.state.host).dispatchEvent(new CustomEvent(P,{detail:o,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:n=null,value:s}=o;this.value=n?s:t.defaultValue,this._unsubscribe=n}teardown(){this._unsubscribe&&this._unsubscribe()}});function bt(t){return o=>{const e={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(P,this)}disconnectedCallback(){this.removeEventListener(P,this)}handleEvent(n){const{detail:s}=n;s.Context===e&&(s.value=this.value,s.unsubscribe=this.unsubscribe.bind(this,s.callback),this.listeners.add(s.callback),n.stopPropagation())}unsubscribe(n){this.listeners.delete(n)}set value(n){this._value=n;for(let s of this.listeners)s(n)}get value(){return this._value}},Consumer:t(function({render:n}){const s=ht(e);return n(s)},{useShadowDOM:!1}),defaultValue:o};return e}}p(class extends m{value;values;constructor(t,o,e,n){super(t,o),this.value=e(),this.values=n}update(t,o){return this.hasChanged(o)&&(this.values=o,this.value=t()),this.value}hasChanged(t=[]){return t.some((o,e)=>this.values[e]!==o)}});function vt(t,o){t[z].push(o)}Q(vt);p(class extends m{args;constructor(t,o,e){super(t,o),this.updater=this.updater.bind(this),typeof e=="function"&&(e=e()),this.makeArgs(e)}update(){return this.args}updater(t){const[o]=this.args;typeof t=="function"&&(t=t(o)),!Object.is(o,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}});p(class extends m{reducer;currentState;constructor(t,o,e,n,s){super(t,o),this.dispatch=this.dispatch.bind(this),this.currentState=s!==void 0?s(n):n}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}});const mt=/([A-Z])/gu;p(class extends m{property;eventName;constructor(t,o,e,n){if(super(t,o),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=e,this.eventName=e.replace(mt,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof n=="function"&&(n=n()),n!=null&&this.updateProp(n))}update(t,o){return[this.state.host[this.property],this.updater]}updater(t){const o=this.state.host[this.property];typeof t=="function"&&(t=t(o)),!Object.is(o,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const o=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(o),o}});p(class extends m{update(){return this.state.host}});function pt({render:t}){const o=ct(t),e=bt(o);return{component:o,createContext:e}}const{component:zt}=pt({render:K}),ft=U(T`
	/*
...
`,f={args:{variant:"primary",size:"md",disabled:!1,fullWidth:!1,label:"Button"},render:kt},y={render:()=>a`
        <div class="story-row">
