import{D as Y,b as l,A as Z}from"./iframe-DFiFGAVW.js";import"./preload-helper-PPVm8Dsz.js";let C,O=0;function L(t){C=t}function T(){C=null,O=0}function q(){return O++}const E=Symbol("haunted.phase"),_=Symbol("haunted.hook"),R=Symbol("haunted.update"),V=Symbol("haunted.commit"),b=Symbol("haunted.effects"),v=Symbol("haunted.layoutEffects"),M="haunted.context";class J{update;host;virtual;[_];[b];[v];constructor(e,o){this.update=e,this.host=o,this[_]=new Map,this[b]=[],this[v]=[]}run(e){L(this);let o=e();return T(),o}_runEffects(e){let o=this[e];L(this);for(let n of o)n.call(this);T()}runEffects(){this._runEffects(b)}runLayoutEffects(){this._runEffects(v)}teardown(){this[_].forEach(o=>{typeof o.teardown=="function"&&o.teardown(!0)})}}const K=Promise.resolve().then.bind(Promise.resolve());function F(){let t=[],e;function o(){e=null;let n=t;t=[];for(var s=0,u=n.length;s<u;s++)n[s]()}return function(n){t.push(n),e==null&&(e=K(o))}}const tt=F(),I=F();class et{renderer;host;state;[E];_updateQueued;_active;constructor(e,o){this.renderer=e,this.host=o,this.state=new J(this.update.bind(this),o),this[E]=null,this._updateQueued=!1,this._active=!0}update(){this._active&&(this._updateQueued||(tt(()=>{let e=this.handlePhase(R);I(()=>{this.handlePhase(V,e),I(()=>{this.handlePhase(b)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,o){switch(this[E]=e,e){case V:this.commit(o),this.runEffects(v);return;case R:return this.render();case b:return this.runEffects(b)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown()}pause(){this._active=!1}resume(){this._active=!0}}const H=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},ot=t=>t?.map(e=>typeof e=="string"?H(e):e),nt=(t,...e)=>t.flatMap((o,n)=>[o,e[n]||""]).join(""),P=nt,st=(t="")=>t.replace(/-+([a-z])?/g,(e,o)=>o?o.toUpperCase():"");function rt(t){class e extends et{frag;renderResult;constructor(s,u,p){super(s,p||u),this.frag=u}commit(s){this.renderResult=t(s,this.frag)}}function o(n,s,u){const p=(u||s||{}).baseElement||HTMLElement,{observedAttributes:$=[],useShadowDOM:N=!0,shadowRootInit:U={},styleSheets:Q}=u||s||{},A=ot(n.styleSheets||Q);class D extends p{_scheduler;static get observedAttributes(){return n.observedAttributes||$||[]}constructor(){if(super(),N===!1)this._scheduler=new e(n,this);else{const r=this.attachShadow({mode:"open",...U});A&&(r.adoptedStyleSheets=A),this._scheduler=new e(n,r,this)}}connectedCallback(){this._scheduler.resume(),this._scheduler.update(),this._scheduler.renderResult?.setConnected(!0)}disconnectedCallback(){this._scheduler.pause(),this._scheduler.teardown(),this._scheduler.renderResult?.setConnected(!1)}attributeChangedCallback(r,c,a){if(c===a)return;let i=a===""?!0:a;Reflect.set(this,st(r),i)}}function G(d){let r=d,c=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return r},set(a){c&&r===a||(c=!0,r=a,this._scheduler&&this._scheduler.update())}})}const X=new Proxy(p.prototype,{getPrototypeOf(d){return d},set(d,r,c,a){let i;return r in d?(i=Object.getOwnPropertyDescriptor(d,r),i&&i.set?(i.set.call(a,c),!0):(Reflect.set(d,r,c,a),!0)):(typeof r=="symbol"||r[0]==="_"?i={enumerable:!0,configurable:!0,writable:!0,value:c}:i=G(c),Object.defineProperty(a,r,i),i.set&&i.set.call(a,c),!0)}});return Object.setPrototypeOf(D.prototype,X),D}return o}class h{id;state;constructor(e,o){this.id=e,this.state=o}}function at(t,...e){let o=q(),n=C[_],s=n.get(o);return s||(s=new t(o,C,...e),n.set(o,s)),s.update(...e)}function m(t){return at.bind(null,t)}function W(t){return m(class extends h{callback;lastValues;values;_teardown;constructor(e,o,n,s){super(e,o),t(o,this)}update(e,o){this.callback=e,this.values=o}call(){const e=!this.values||this.hasChanged();this.lastValues=this.values,e&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(e){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),e&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((e,o)=>this.lastValues[o]!==e)}})}function j(t,e){t[b].push(e)}const it=W(j),ct=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,lt=m(class extends h{Context;value;_ranEffect;_unsubscribe;constructor(t,e,o){super(t,e),this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,j(e,this)}update(t){return this.Context!==t&&(this._subscribe(t),this.Context=t),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(t){this.value=t,this.state.update()}_subscribe(t){const e={Context:t,callback:this._updater};ct(this.state.host).dispatchEvent(new CustomEvent(M,{detail:e,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:n=null,value:s}=e;this.value=n?s:t.defaultValue,this._unsubscribe=n}teardown(){this._unsubscribe&&this._unsubscribe()}});function dt(t){return e=>{const o={Provider:class extends HTMLElement{listeners;_value;constructor(){super(),this.style.display="contents",this.listeners=new Set,this.addEventListener(M,this)}disconnectedCallback(){this.removeEventListener(M,this)}handleEvent(n){const{detail:s}=n;s.Context===o&&(s.value=this.value,s.unsubscribe=this.unsubscribe.bind(this,s.callback),this.listeners.add(s.callback),n.stopPropagation())}unsubscribe(n){this.listeners.delete(n)}set value(n){this._value=n;for(let s of this.listeners)s(n)}get value(){return this._value}},Consumer:t(function({render:n}){const s=lt(o);return n(s)},{useShadowDOM:!1}),defaultValue:e};return o}}m(class extends h{value;values;constructor(t,e,o,n){super(t,e),this.value=o(),this.values=n}update(t,e){return this.hasChanged(e)&&(this.values=e,this.value=t()),this.value}hasChanged(t=[]){return t.some((e,o)=>this.values[o]!==e)}});function ut(t,e){t[v].push(e)}W(ut);m(class extends h{args;constructor(t,e,o){super(t,e),this.updater=this.updater.bind(this),typeof o=="function"&&(o=o()),this.makeArgs(o)}update(){return this.args}updater(t){const[e]=this.args;typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&(this.makeArgs(t),this.state.update())}makeArgs(t){this.args=Object.freeze([t,this.updater])}});m(class extends h{reducer;currentState;constructor(t,e,o,n,s){super(t,e),this.dispatch=this.dispatch.bind(this),this.currentState=s!==void 0?s(n):n}update(t){return this.reducer=t,[this.currentState,this.dispatch]}dispatch(t){this.currentState=this.reducer(this.currentState,t),this.state.update()}});const bt=/([A-Z])/gu;m(class extends h{property;eventName;constructor(t,e,o,n){if(super(t,e),this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=o,this.eventName=o.replace(bt,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof n=="function"&&(n=n()),n!=null&&this.updateProp(n))}update(t,e){return[this.state.host[this.property],this.updater]}updater(t){const e=this.state.host[this.property];typeof t=="function"&&(t=t(e)),!Object.is(e,t)&&this.updateProp(t)}updateProp(t){this.notify(t).defaultPrevented||(this.state.host[this.property]=t)}notify(t){const e=new CustomEvent(this.eventName,{detail:{value:t,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(e),e}});m(class extends h{update(){return this.state.host}});function ht({render:t}){const e=rt(t),o=dt(e);return{component:e,createContext:o}}const{component:mt}=ht({render:Y}),vt=H(P`
	/*
...
`,z={args:{variant:"primary",size:"md",disabled:!1,fullWidth:!1,label:"Button"},render:gt},f={render:()=>l`
        <div class="story-row">
...
}`,...B.parameters?.docs?.source}}};const St=["Default","Variants","Sizes","DisabledStates","WithIcons","FullWidth","SizeVariantMatrix","InteractiveStates","Accessibility"];export{B as Accessibility,z as Default,g as DisabledStates,w as FullWidth,S as InteractiveStates,k as SizeVariantMatrix,y as Sizes,f as Variants,x as WithIcons,St as __namedExportsOrder,kt as default};
